  ...
  const companyExperiences = [
    {
      ...
      logo: "c1x-logo.png",
      description: "Leading adtech company specializing in programmatic advertising and digital out-of-home solutions.",
      roles: [
        {
    ...
    },
    {
      ...
      description: "Leading tech education platform focused on upskilling software engineers.",
      roles: [
        {
    ...
    },
    {
      ...
      duration: "2020 - 2021",
      description: "Google-supported technical community that bridges the gap between theory and practical application.",
      roles: [
        {
          role: "Overall Lead",
          period: "2020 - 2021",
    ...
    },
    {
      company: "Oracle",
      duration: "2019",
      description: "Multinational technology corporation specializing in database software and technology, cloud systems.",
      roles: [
        {
    ...
    },
    {
      ...
      duration: "2019",
      description: "Global professional services network providing audit, consulting, financial advisory, risk advisory services.",
      roles: [
        {
          role: "Offshore Contractor",
          period: "2019",
    ...
    },
    {
      company: "FOSSASIA",
      duration: "2019",
      description: "Open source organization developing software applications for social change using a wide range of technologies.",
      roles: [
        {
      ...
      <div className="container mx-auto">
        ...
        <div className="space-y-8">
          {companyExperiences.map((company, companyIndex) => (
            <Card 
              key={companyIndex}
              className={`card-hover overflow-hidden border border-muted ${company.company === "C1X Adtech Inc." ? 'ring-2 ring-tech-purple' : ''}`}
            >
                  ...
                  <div>
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-foreground/70">{company.duration}</div>
                      </div>
                    </div>
                  </div>
                          ...
                          <div key={roleIndex} className="relative">
                            ...
                            <div className="flex">
                              ...
                              <div className="relative z-10 mr-6">
                                <div className={`w-8 h-8 rounded-full ${role.isLatest ? 'bg-tech-purple text-white' : 'bg-secondary border border-tech-purple/30'} flex items-center justify-center`}>
                                  {role.isLatest ? <ArrowUpRightIcon size={16} /> : roleIndex + 1}
                                </div>
                              </div>
                              ...
                              <div className="flex-1">
                                <div className="mb-4">
                                  <div className="flex flex-wrap items-center gap-2 mb-2">
                                    ...
                                    <div className="text-sm text-foreground/70">{role.period}</div>
                                ...
                                <div>
                                  <h5 className="text-sm font-bold mb-2">TECHNOLOGIES</h5>
                                  <div className="flex flex-wrap gap-2">
